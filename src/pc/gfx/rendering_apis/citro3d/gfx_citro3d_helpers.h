...
// Converts an RSP matrix to a C3D matrix and transposed pair. RSP matrices are column-major, while C3D matrices are row-major with each row reversed left-right.
