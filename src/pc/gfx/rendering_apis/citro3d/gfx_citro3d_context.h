...
typedef enum
{
    ...
    CTX_TEXTURE_1                   = BIT(1),
    CTX_UV_OFFSET                   = BIT(2),
    CTX_CURRENT_TEXTURE             = BIT(3),
    CTX_CULL_MODE                   = BIT(4),
    CTX_USE_ALPHA                   = BIT(5),
    CTX_ZMODE_DECAL                 = BIT(6),
    CTX_DEPTH_TEST                  = BIT(7),
    CTX_DEPTH_UPDATE                = BIT(8),
    CTX_ALPHA_TEST                  = BIT(9),
    CTX_PRIM_COLOR                  = BIT(10),
    CTX_ENV_COLOR                   = BIT(11),
    CTX_TEXENV                      = BIT(12),
    CTX_VIEWPORT                    = BIT(13),
    CTX_SCISSOR                     = BIT(14),
    CTX_FOG_COLOR                   = BIT(15),
    CTX_VERTEX_LOAD_NUM_LIGHTS      = BIT(16),
    CTX_VERTEX_LOAD_TEXGEN          = BIT(17),
    CTX_VERTEX_LOAD_TEXTURE_SCALE   = BIT(18),
    CTX_FOG                         = BIT(19),
    CTX_SHADER                      = BIT(20),
