...
ifeq ($(TARGET_N3DS),1)
  ...
  PLATFORM_CFLAGS  := -mtp=soft -DTARGET_N3DS -DRSPA_USE_ENHANCEMENTS -DARM11 -DosGetTime=n64_osGetTime -D_3DS -D__3DS__ -march=armv6k -mtune=mpcore -mfloat-abi=hard -mword-relocations -fomit-frame-pointer -ffast-math $(foreach dir,$(LIBDIRS),-I$(dir)/include)
